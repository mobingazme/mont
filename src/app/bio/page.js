  ...
  return (
    <div className=' h-screen w-screen bg-A  flex justify- items-'>
      <div className='max-w-[760px] w-full h-fit'>
        <div className=' relative bg-[url(/images/stick.png)] bg-cover bg-center max-w-[350px] h-[600px] mx-auto'>
          <div className=' absolute top-0 left-0 object-cover  '>{/*mr-32 */}
            ...
            <div className='w-full '>{/* */}
              ...
              <div className=' flex items-center justify-between cursor-pointer w-[200px] h-10 bg-B border-2 border-B hover:border-C rounded-2xl delay-150 transition-all mb-3'>
            ...
            <div className=' flex items-center justify-between cursor-pointer w-[200px] h-10 bg-B border border-B hover:border-C rounded-2xl delay-150 transition-all '>
